...
PR_URL=$(gh pr create --title "Pair PR $TS" --body "Pair Extraordinaire via push-helper")
gh pr merge "$PR_URL" --merge --admin
echo "Success! Checked your profile for Pair Extraordinaire: https://github.com/tonrisers?tab=achievements"
